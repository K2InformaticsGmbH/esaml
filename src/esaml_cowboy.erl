...
validate_logout(SP, Req) ->
    case cowboy_req:method(Req) of
        ...
        <<"GET">> ->
            ...
            SAMLEncoding = proplists:get_value(<<"SAMLEncoding">>, Params),
            SAMLResponse = case proplists:get_value(<<"SAMLResponse">>, Params) of
                undefined -> proplists:get_value(<<"SAMLRequest">>, Params);
                Other -> Other
            end,
            RelayState = proplists:get_value(<<"RelayState">>, Params, <<>>),
